...
class MovimientoInventarioController extends Controller
{
    ...
    public function ListaMovimientoInventario(Request $request){
        try {
            ...
            $resultado = $this->service->ServListaMovimientoInventario(
            ...
            return response()->json([
                'estado'  => 'success',
                'mensaje' => 'Lista de movimientos de inventario',
                'data'    => $resultado
            ], 200);
